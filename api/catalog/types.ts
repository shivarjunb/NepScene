...
/**
 * Where a request appears to be coming from, as `/api/catalog/here` answers it
 * (#38). Declared here rather than in the handler so the browser can import
 * the shape without importing a Hono app.
 */
export type Here = {
  city: string
