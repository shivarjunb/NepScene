...
/**
 * A row card is 300px, or half the screen on a phone; a grid card is one
 * column of a four or two-up grid, and on a phone a 6.5rem thumbnail beside
 * its text. Without a `sizes` hint the browser assumes full-viewport width and
 * fetches the widest rung there is, which is the whole feature undone.
 */
const GRID_SIZES = '(max-width: 40rem) 6.5rem, (max-width: 68.75rem) 45vw, 25vw'
const ROW_SIZES = '(max-width: 40rem) 50vw, 18.75rem'
